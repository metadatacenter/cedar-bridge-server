 ...
 *
 * <p>This service reached that state twice over: none of its five operations described a payload,
 * and the tree node it takes as a request body registered a schema with no members at all.</p>
 */
